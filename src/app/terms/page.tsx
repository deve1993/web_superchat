      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div>
          ...
          <p className="text-[#73799B] leading-relaxed mb-4">
            I presenti termini e condizioni regolano l'uso del sito web <span className="font-medium text-white">superchat.fl1.cz</span> e del software <span className="font-medium text-white">SuperChat per Odoo 18</span> fornito da <span className="font-medium text-white">Persevida sro</span>. Accedendo al sito o utilizzando il software, l'utente accetta di essere vincolato dai presenti termini.
          </p>
          ...
          <ul className="list-disc list-inside text-[#73799B] space-y-2 mb-4">
            ...
            <li>Tentare di accedere in modo non autorizzato a aree riservate o sistemi informatici di <span className="font-medium text-white">Persevida sro</span>.</li>
          </ul>
          ...
          <p className="text-[#73799B] leading-relaxed mb-4">
            Il marchio <span className="font-medium text-white">SuperChat</span>, il logo, i contenuti testuali, grafici e il design del sito web sono di proprietà esclusiva di <span className="font-medium text-white">Persevida sro</span>. Sebbene il software sia open source, il branding e gli asset grafici del sito restano protetti dalle leggi sulla proprietà intellettuale.
          </p>
          ...
          <p className="text-[#73799B] leading-relaxed mb-4">
            Inviando il modulo di contatto, l'utente acconsente a essere ricontattato da <span className="font-medium text-white">Persevida sro</span> per le finalità indicate nella richiesta (es. demo, preventivo). L'invio di comunicazioni di marketing o newsletter richiede un consenso separato e facoltativo.
          </p>
          ...
          <p className="text-[#73799B] leading-relaxed mb-4">
            Il sito può contenere collegamenti a siti web di terze parti. <span className="font-medium text-white">Persevida sro</span> non esercita alcun controllo su tali siti e non è responsabile del loro contenuto, delle loro pratiche in materia di privacy o dei termini di utilizzo.
          </p>
          ...
          <p className="text-[#73799B] leading-relaxed mb-4">
            <span className="font-medium text-white">Persevida sro</span><br />
          ...
          <p className="text-[#73799B] leading-relaxed mb-4">
            <span className="font-medium text-white">Persevida sro</span> si riserva il diritto di modificare i presenti termini in qualsiasi momento. Le eventuali modifiche saranno pubblicate su questa pagina e diventeranno effettive immediatamente dopo la pubblicazione. Si consiglia di consultare regolarmente questa sezione.
          </p>
        </div>
      </div>
    </section>
